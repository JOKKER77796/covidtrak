...
List<ContryModel> userFromJson(String str) => List<ContryModel>.from(
    json.decode(str).map((x) => ContryModel.fromJson(x)));
...
class ContryModel {
  ...
  ContryModel.fromJson(Map<String, dynamic> json) {
